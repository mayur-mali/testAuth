<template>
  <div
    _style="max-height: 800px;"
    _class="overflow-y-auto"
  >
    <div class="bg-white">
          ...
          <div class="bg-gray-900 pt-6">
            ...
            >
              ...
              >
                ...
                <button
                  class="inline-flex items-center cursor-pointer px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700"
                  @click="logout()"
                >
                  Logout
                </button>
                    ...
                    <div class="mt-10 sm:mt-12">
                      ...
                      >
                        ...
                        <p class="mt-3 text-sm text-gray-300 sm:mt-4">
                          Start your free 14-day trial, no credit card necessary. By providing your email, you agree to our <a
                            href="#"
  ...
  methods: {
    async logout () {
      await this.$auth.logout(
        this.$auth.$storage.removeLocalStorage('access_token'),
        // this.$toast.show({
        //   type: 'success',
        //   title: 'Success',
        //   message: `Thanks To working with us.. ${this.$auth.user.user.name}`,
